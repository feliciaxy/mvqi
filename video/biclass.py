...
class User():
    def __init__(self,m_mid=None,m_name=None):
        ...
        self.totalVideoView = None
        self.totalarticleView = None
        self.mtime = None
        self.tag = None
        self.sign = None
#   获取空间地址
...
def to_video_dict(video1):
    return {
        'aid': video1.aid,
        'upName': video1.upName,
        'upID': video1.upID,
        'guankan': video1.guankan,
        'commentNumber': video1.commentNumber,
        'danmu': video1.danmu,
        'like': video1.like,
        'shoucang': video1.shoucang,
        'coin': video1.coin,
        'share': video1.share,
        'nowRank': video1.nowRank,
        'hisRank': video1.hisRank,
        'timestamp': video1.now,
    }